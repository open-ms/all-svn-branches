...
{    
  ...
  connect(listview_, SIGNAL(clicked(Q3ListViewItem*)), this, SLOT(showDetails_(Q3ListViewItem*))  );
...
void MSMetaDataExplorer::showDetails_(Q3ListViewItem *item)
{
...
void MSMetaDataExplorer::updateProteinHits_(ProteinIdentification pid, int tree_item_id)
{
		...
		const QString qs = String(tree_item_id).c_str();
		Q3ListViewItem *item =listview_->findItem(qs, 1);
		
			
		item->sortChildItems(2, true);
		//item->sort();		
		// get all children of this item
		Q3ListViewItem *first =item->firstChild();
		Q3ListViewItem *current = first;
...
void MSMetaDataExplorer::updateNonRefPeptideHits_(Identification id, int tree_item_id)
{
		...
		Q3ListViewItem *item =listview_->findItem(QString::number(tree_item_id), 1);
				...
				for(UnsignedInt i=0; i<hits->size(); ++i)
				{
				  ...
				  String score((*hits)[i].getScore());
					...
					name = name+ seq+" (" +score+")";
						...
						if( current->text(0)==name.c_str() && current->text(3)== seq.c_str())
						{
								current->setVisible(true);
								break;
						}
...
void MSMetaDataExplorer::visualize_(Sample &s, Q3ListViewItem* parent )
{
    ...
    String w_id(widgetID);
		...
		if(parent == 0)
		{
			item = new Q3ListViewItem(listview_, listview_->lastItem(), id.c_str() , w_id.c_str(), "0" );
		}
		else
		{
			item = new Q3ListViewItem(parent, id.c_str() , w_id.c_str(), "0" );
		}
...
void MSMetaDataExplorer::visualize_(MetaInfoInterface &m, Q3ListViewItem* parent)
{
		...
		if(parent==0)
		{
			new Q3ListViewItem(listview_, listview_->lastItem(), "MetaInfo" , w_id.c_str(), "0" );
		}
		else
		{
			new Q3ListViewItem(parent, "MetaInfo" , w_id.c_str(), "0" );
		}
...
void MSMetaDataExplorer::visualize_(Digestion &d, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			item =new Q3ListViewItem(listview_, listview_->lastItem(), "Digestion" , w_id.c_str(), "0" );
			 	
		}
		else
		{
			item = new Q3ListViewItem(parent, "Digestion" , w_id.c_str(), "0" );
		}
...
void MSMetaDataExplorer::visualize_(Modification &m, Q3ListViewItem* parent)
{
		Q3ListViewItem* item;
    int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			item =new Q3ListViewItem(listview_, listview_->lastItem(), "Modification" , w_id.c_str(), "0" );
		}
		else
		{
			item = new Q3ListViewItem(parent, "Modification" , w_id.c_str(), "0" );
		}
		//check for metainfo objects
		if(! m.isMetaEmpty() )
		{
...
void MSMetaDataExplorer::visualize_(Tagging &t, Q3ListViewItem* parent)
{
		Q3ListViewItem* item;
    int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			item =new Q3ListViewItem(listview_, listview_->lastItem(), "Tagging" , w_id.c_str(), "0" );
		}
		else
		{
			item =new Q3ListViewItem(parent, "Tagging" , w_id.c_str(), "0" );  
		}
		//check for metainfo objects
		if(! t.isMetaEmpty() )
		{
...
void MSMetaDataExplorer::visualize_(Software &s, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
    int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			item = new Q3ListViewItem(listview_, listview_->lastItem(), "Software" , w_id.c_str(), "0" );
		}
		else
		{
			item = new Q3ListViewItem(parent, "Software" , w_id.c_str(), "0" );  
		}
...
void MSMetaDataExplorer::visualize_(HPLC &h, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
    int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			item = new Q3ListViewItem(listview_, listview_->lastItem(), "HPLC" , w_id.c_str(), "0" );
		}
		else
		{
			item = new Q3ListViewItem(parent, "HPLC" , w_id.c_str(), "0" );  
		}
...
void MSMetaDataExplorer::visualize_(Gradient &gradient, Q3ListViewItem* parent)
{
    int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			new Q3ListViewItem(listview_, listview_->lastItem(), "Gradient" , w_id.c_str(), "0" );
		}
		else
		{
			new Q3ListViewItem(parent, "Gradient" , w_id.c_str(), "0" );  
		}
...
void MSMetaDataExplorer::visualize_(SourceFile &source, Q3ListViewItem* parent)
{
    int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			new Q3ListViewItem(listview_, listview_->lastItem(), "SourceFile" , w_id.c_str(), "0" );
		}
		else
		{
			new Q3ListViewItem(parent, "SourceFile" , w_id.c_str(), "0" );  
		}
...
void MSMetaDataExplorer::visualize_(ContactPerson &person, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			item = new Q3ListViewItem(listview_, listview_->lastItem(), "ContactPerson" , w_id.c_str(), "0" );
		}
		else
		{
			item = new Q3ListViewItem(parent, "ContactPerson" , w_id.c_str(), "0" );  
		}
...
void MSMetaDataExplorer::visualize_(Instrument &instrument, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			item = new Q3ListViewItem(listview_, listview_->lastItem(), "Instrument" , w_id.c_str(), "0" );
		}
		else
		{
			item = new Q3ListViewItem(parent, "Instrument" , w_id.c_str(), "0" );  
		}
...
void MSMetaDataExplorer::visualize_(IonSource &is, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			item = new Q3ListViewItem(listview_, listview_->lastItem(), "IonSource" , w_id.c_str(), "0" );
		}
		else
		{
			item = new Q3ListViewItem(parent, "IonSource" , w_id.c_str(), "0" );  
		}
...
void MSMetaDataExplorer::visualize_(IonDetector &id, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			item = new Q3ListViewItem(listview_, listview_->lastItem(), "IonDetector" , w_id.c_str(), "0" );
		}
		else
		{
			item = new Q3ListViewItem(parent, "IonDetector" , w_id.c_str(), "0" );  
		}
...
void MSMetaDataExplorer::visualize_(MassAnalyzer &ma, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			item = new Q3ListViewItem(listview_, listview_->lastItem(), "MassAnalyzer" , w_id.c_str(), "0" );
		}
		else
		{
			item = new Q3ListViewItem(parent, "MassAnalyzer" , w_id.c_str(), "0" );  
		}
...
void MSMetaDataExplorer::visualize_(ProcessingMethod &pm, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			item = new Q3ListViewItem(listview_, listview_->lastItem(), "ProcessingMethod" , w_id.c_str(), "0" );
		}
		else
		{
			item = new Q3ListViewItem(parent, "ProcessingMethod" , w_id.c_str(), "0" );  
		}
...
void MSMetaDataExplorer::visualize_(ProteinIdentification &pid, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			item = new Q3ListViewItem(listview_, listview_->lastItem(), "ProteinIdentification" , w_id.c_str(), "0" );
		}
		else
		{
			item = new Q3ListViewItem(parent, "ProteinIdentification" , w_id.c_str(), "0" );  
		}
...
void MSMetaDataExplorer::visualize_(Identification &id, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			item = new Q3ListViewItem(listview_, listview_->lastItem(), "Identification" , w_id.c_str(), "0" );
		}
		else
		{
			item = new Q3ListViewItem(parent, "Identification" , w_id.c_str(), "0" );  
		}
...
void MSMetaDataExplorer::visualize_(ProteinHit &phit, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		...
		if(parent==0)
		{
			item = new Q3ListViewItem(listview_, listview_->lastItem(), name.c_str() , w_id.c_str(), String(phit.getScore()).c_str()   );
		}
		else
		{
			item = new Q3ListViewItem(parent, name.c_str() , w_id.c_str(), String(phit.getScore()).c_str());  
		}
...
void MSMetaDataExplorer::visualize_(PeptideHit &pephit, Q3ListViewItem* parent, vector<ProteinHit> *prots )
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		...
		if(parent==0)
		{
				item = new Q3ListViewItem(listview_, listview_->lastItem(), name.c_str() , w_id.c_str(), String(pephit.getScore()).c_str(), pephit.getSequence().c_str()   );
		}
		else
		{
				//(parent, Col0=name, Col1=w_id ,Col2=score)
				item = new Q3ListViewItem(parent, name.c_str() , w_id.c_str(), String(pephit.getScore()).c_str(), pephit.getSequence().c_str());  
		}
...
void MSMetaDataExplorer::visualize_(ExperimentalSettings &es, Q3ListViewItem* parent)
{
		...
		if(parent==0)
		{
			item =new Q3ListViewItem(listview_, listview_->lastItem(), "ExperimentalSettings" , w_id.c_str(), "0" );
		}
		else
		{
			item = new Q3ListViewItem(parent, "ExperimentalSettings" , w_id.c_str(), "0" );
		}
...
void MSMetaDataExplorer::visualize_(SpectrumSettings &ss, Q3ListViewItem* parent)
{
		Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		if(parent==0)
		{
			item =new Q3ListViewItem(listview_, listview_->lastItem(), "SpectrumSettings" , w_id.c_str(), "0" );
		}
		else
		{
			item = new Q3ListViewItem(parent, "SpectrumSettings" , w_id.c_str(), "0" );
		}
...
void MSMetaDataExplorer::visualize_(InstrumentSettings &is, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		...
		if(parent==0)
		{
			item =new Q3ListViewItem(listview_, listview_->lastItem(), "InstrumentSettings" , w_id.c_str(), "0" );
			 	
		}
		else
		{
			item = new Q3ListViewItem(parent, "InstrumentSettings" , w_id.c_str(), "0" );
		}
...
void MSMetaDataExplorer::visualize_(Acquisition &a, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		...
		if(parent==0)
		{
			item =new Q3ListViewItem(listview_, listview_->lastItem(), name.c_str() , w_id.c_str(), "0" );
			 	
		}
		else
		{
			item = new Q3ListViewItem(parent, name.c_str() , w_id.c_str(), "0" );
		}
...
void MSMetaDataExplorer::visualize_(AcquisitionInfo &ai, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		...
		if(parent==0)
		{
			item =new Q3ListViewItem(listview_, listview_->lastItem(), "Acquisition Info " , w_id.c_str(), "0" );
			 	
		}
		else
		{
			item = new Q3ListViewItem(parent, "Acquisition Info " , w_id.c_str(), "0" );
		}
...
void MSMetaDataExplorer::visualize_(MetaInfoDescription &mid,  Q3ListViewItem* parent, String* key)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
...
void MSMetaDataExplorer::visualize_(Precursor &pre, Q3ListViewItem* parent)
{
    Q3ListViewItem* item;
		int widgetID = makeID_();
		String w_id(widgetID);
		...
		if(parent==0)
		{
			item =new Q3ListViewItem(listview_, listview_->lastItem(), "Precursor " , w_id.c_str(), "0" );
			 	
		}
		else
		{
			item = new Q3ListViewItem(parent, "Precursor " , w_id.c_str(), "0" );
		}
