                                                                ...
                                                                bool solve_ILP)
{
  ...
  std::cout << rt_step_size << std::endl;
  ...
  std::cout << "added proteins to LP"<<std::endl;
  ///////////////////////////////////////////////////////////////////////
  ...
  std::cout << "added inclusion list size constraint to LP"<<std::endl;
  //////////////////////////////////////////////////////////////////////////
  // constraint 2: rt_bin_capacity
  //////////////////////////////////////////////////////////////////////////
  addRTBinCapacityConstraint_(variable_indices,max_index,ms2_spectra_per_rt_bin);
  std::cout << "added rt bin capacity constraint to LP"<<std::endl;
  ///////////////////////////////////////////////////////////////////////
  // constraint 3: protein coverage
  ///////////////////////////////////////////////////////////////////////
  std::cout << "add protein coverage constraint"<<std::endl;
  addProteinCoverageConstraint_(variable_indices,preprocessing,protein_penalty_index_map);
  std::cout << "added protein coverage constraint"<<std::endl;
  std::cout << pep_counter << " peptides are possible\n";
  std::cout << "model was built, has "<<variable_indices.size()<< " variables" <<std::endl;
  ...
  if(solve_ILP)
    {
      ...
      solveILP(solution_indices);
      //TODO: wie uebergabe der loesdung machen? ev opis zwischenschalten??
//      std::cout <<"variable indices:\n";
//      for(Size vi = 0; vi < variable_indices.size();++vi)
//        {
//          std::cout << vi <<" "<<variable_indices[vi].feature <<" "<<variable_indices[vi].scan <<" "<<variable_indices[vi].variable<<std::endl;
//        }
//      std::cout <<"done\n";
...
void PSLPFormulation::solveILP(std::vector<int>& solution_indices,Int /*iteration*/,bool /*targeted*/,Size /*rt_bin_capacity*/)
{
  ...
  model_->solve(param);
  t.stop();
  std::cerr <<"Time to solve ILP: "
            << "Clock "<< t.getClockTime()
            << " User "<< t.getUserTime()
            << " System "<< t.getSystemTime()
            << " CPU "<< t.getCPUTime() << std::endl;
...
#ifdef DEBUG_OPS	
      std::cout << " is in optimal solution " << model_->getColumnName(column)<< std::endl;
#endif
