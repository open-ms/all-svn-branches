...
#ifdef USE_ANDIMS
		setValidFormats_("in",StringList::create("mzData,mzXML,mzML,DTA,DTA2D,cdf,mgf,fid"));
#else
		setValidFormats_("in",StringList::create("mzData,mzXML,mzML,DTA,DTA2D,mgf,fid"));
#endif
		registerStringOption_("in_type","<type>","","input file type (default: determined from file extension or content)\n", false);
#ifdef USE_ANDIMS
		setValidStrings_("in_type",StringList::create("mzData,mzXML,mzML,DTA,DTA2D,cdf,mgf,fid"));
#else
		setValidStrings_("in_type",StringList::create("mzData,mzXML,mzML,DTA,DTA2D,mgf,fid"));
#endif
