...
/**
	@page TOPP_PeakExporter PeakExporter
...
<CENTER>
	<table>
		<tr>
			...
			<td VALIGN="middle" ROWSPAN=2> \f$ \longrightarrow \f$ PeakExporter \f$ \longrightarrow \f$</td>
	...
	@verbinclude TOPP_PeakExporter.cli
*/

// We do not want this class to show up in the docu:
/// @cond TOPPCLASSES

class TOPPPeakExporter
	: public TOPPBase
{
	public:
		TOPPPeakExporter()
			: TOPPBase("PeakExporter","Extracts spectra of an MS run file to several files in DTA format.")
		{
