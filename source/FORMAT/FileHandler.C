...
const std::string FileHandler::NamesOfTypes[] = {"Unknown", "DTA", "DTA2D", "mzData", "mzXML", "FeatureXML", "IdXML", "ConsensusXML", "mgf", "ini", "toppas", "TrafoXML", "mzML", "ms2", "pepXML", "protXML", "mzid","mzq", "GelML", "TraML", "MSP", "OMSSAXML", "MASCOTXML", "PNG", "fid", "tsv", "pepList", "hardkloer","kroenik", "fasta", "edta", "sptxt", "splib", "pepidx", "spidx"};
    ...
    if (all_simple.hasSubstring("<mzML")) return FileTypes::MZML;
		...
		if (all_simple.hasSubstring("<mzQuantML")) return FileTypes::MZQUANTML;
