...
namespace OpenMS
{
CrossCorrelationCalculator1::CrossCorrelationCalculator1(DoubleReal stepwidth,DoubleReal gauss_mean, DoubleReal gauss_sigma) : stepwidth_(stepwidth), gauss_mean_(gauss_mean), gauss_sigma_(gauss_sigma) {
	// TODO Auto-generated constructor stub

}

CrossCorrelationCalculator1::~CrossCorrelationCalculator1() {
	// TODO Auto-generated destructor stub
}

std::vector<DoubleReal> CrossCorrelationCalculator1::calculate(const MSExperiment<Peak1D>& input, MSExperiment<Peak1D>& output,Size spectrum_selection_id)
{
...
std::vector<DoubleReal> CrossCorrelationCalculator1::analyzeSpectrum(const MSSpectrum<Peak1D>& input, MSSpectrum<Peak1D>& output, bool gauss_fitting)
{
...
std::vector<DoubleReal> CrossCorrelationCalculator1::getExactPositions(const std::vector<DoubleReal>& data,std::vector<DoubleReal> positions, DoubleReal tolerance)
{
