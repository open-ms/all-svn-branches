...
HANDLE h;
CHECK([EXTRA](static void* OpenMS_mmap (const std::size_t& size, const HANDLE& handle, const Int64& file_offset)))
#else
long h;
CHECK([EXTRA](static void* OpenMS_mmap (const std::size_t& size, const int& fileHandle, const Int64& file_offset)))
#endif
{
	String filename;
