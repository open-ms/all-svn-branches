...
START_TEST(TextFile, "$Id: SettingsParser_test.C 5002 2009-07-28 guillaume_belz $")

/////////////////////////////////////////////////////////////

START_SECTION((static bool exists(const String &file)))
	TEST_EQUAL(File::exists("settings.txt"), false)
	TEST_EQUAL(File::exists(OPENMS_GET_TEST_DATA_PATH("settings.txt")), true)
END_SECTION
/*
